defmodule Back.AutomatonsCommentsTest do
  ...
  describe "automaton_comment" do
    ...
    test "get_automaton_comments!/1 returns the automaton_comments with given id" do
      ...
      assert AutomatonsComments.get_automaton_comments!(automaton_comments.id) ==
               automaton_comments
    end
    ...
    test "create_automaton_comments/1 with valid data creates a automaton_comments" do
      ...
      assert {:ok, %AutomatonComments{} = automaton_comments} =
               AutomatonsComments.create_automaton_comments(valid_attrs)
    ...
    test "create_automaton_comments/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} =
               AutomatonsComments.create_automaton_comments(@invalid_attrs)
    end
    ...
    test "update_automaton_comments/2 with valid data updates the automaton_comments" do
      ...
      assert {:ok, %AutomatonComments{} = automaton_comments} =
               AutomatonsComments.update_automaton_comments(automaton_comments, update_attrs)
    ...
    test "update_automaton_comments/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               AutomatonsComments.update_automaton_comments(automaton_comments, @invalid_attrs)

      assert automaton_comments ==
               AutomatonsComments.get_automaton_comments!(automaton_comments.id)
    end

    test "delete_automaton_comments/1 deletes the automaton_comments" do
      automaton_comments = automaton_comments_fixture()

      assert {:ok, %AutomatonComments{}} =
               AutomatonsComments.delete_automaton_comments(automaton_comments)
