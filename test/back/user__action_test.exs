defmodule Back.User_ActionTest do
  ...
  describe "blocked" do
    ...
    test "create_blocked/1 with valid data creates a blocked" do
      valid_attrs = %{blocked_id: "some blocked_id", time_unblock: ~N[2025-04-15 18:03:00], blocked_at: ~N[2025-04-15 18:03:00]}
    ...
    test "update_blocked/2 with valid data updates the blocked" do
      blocked = blocked_fixture()
      update_attrs = %{blocked_id: "some updated blocked_id", time_unblock: ~N[2025-04-16 18:03:00], blocked_at: ~N[2025-04-16 18:03:00]}
