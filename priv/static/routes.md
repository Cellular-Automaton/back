```
  ...
  GET     /api/automaton/recent/:nb             BackWeb.AutomatonController :get_recents
  GET     /api/automaton_comment/automaton/:id  BackWeb.AutomatonCommentsController :get_by_automaton
  ...
  GET     /api/user/favorite/:user_id           BackWeb.FavoriteController :get_by_user
  ...
  GET     /api/tag                              BackWeb.TagController :index
  GET     /api/tag/:id                          BackWeb.TagController :show
  POST    /api/tag                              BackWeb.TagController :create
  PATCH   /api/tag/:id                          BackWeb.TagController :update
  PUT     /api/tag/:id                          BackWeb.TagController :update
  DELETE  /api/tag/:id                          BackWeb.TagController :delete
  GET     /api/automaton_tag                    BackWeb.AutomatonTagController :index
  GET     /api/automaton_tag/:id                BackWeb.AutomatonTagController :show
  POST    /api/automaton_tag                    BackWeb.AutomatonTagController :create
  PATCH   /api/automaton_tag/:id                BackWeb.AutomatonTagController :update
  PUT     /api/automaton_tag/:id                BackWeb.AutomatonTagController :update
  DELETE  /api/automaton_tag/:id                BackWeb.AutomatonTagController :delete
